...
Now I will make a second user Bob, who will be our Analyst in the lab. Bob will be a member of the Domain Users group. Since this is a default group I just have to create the Bob user.
...
After creating the local account, the Windows installer will run a lengthy process of downloading and installing the latest updates.
