...
Once I am satisfied with my users I can move on to creating the Windows 11 workstation machine. 
...
Once you get to this step you should be basically done setting up the windows environment. Later on we will need to install Sysmon and a log forwarder on all of our devices but I will save that for the Splunk stage of the project. Up next we need to build a Security Onion VM to act as a network monitor.
